...
$BET_AMOUNT = 5.0; // Changed to 5 DUCO
$WIN_AMOUNT = 10.0; // Win amount is 10 DUCO
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['guess'])) {
    ...
    // Updated range verification
    if ($guess < 1 || $guess > 100) {
        echo json_encode(array("error" => "Invalid guess. Please choose a number between 1 and 100"));
...
<html>
<head>
    <title>DuinoCoin Number Game (1-100)</title>
...
<body>
    <div class="container">
        <h1>DuinoCoin Number Game (1-100)</h1>
        <p class="info">
            Bet 5 DUCO to play. Win 10 DUCO if you guess correctly!<br>
        ...
        <form id="guessForm">
            ...
            <button type="submit" id="submitBtn">Play (Bet 5 DUCO)</button>
        </form>
        <div id="result"></div>
    </div>
    ...
    <div class="footer-container">
        <div class="footer-content">
            <div class="disclaimer">
                ...
                <p>This script is completely random with no favorable odds. It is not rigged nor a scam. 
    ...
    <script>
        document.getElementById('guessForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                submitBtn.textContent = 'Play (Bet 5 DUCO)';
            }
        });
